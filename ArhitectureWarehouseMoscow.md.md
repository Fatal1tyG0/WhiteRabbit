...
> После заполнения вышеуказанных сведений "Остатки товара" из компонента `InventoryStock` приобретают свойства компонента `MyGoods` и дальнейшая работа ведется именно по этому компоненту. Пример: пользователь отправил на "Приёмку грузов" товар (объект) со следующими свойствами: 1) Название - кро
---

<!--stackedit_data:
eyJoaXN0b3J5IjpbNTU0NTgwNzU4LC0zNTY0MzQ5MTQsMTM2NT
EwOTIzMl19
-->