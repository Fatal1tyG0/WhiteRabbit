...
Данный компонент заполняется через форму для пользователя, которая выглядит следующим образом: 1) Название товара, 2) Количество товара, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5OTY3MDM5MiwtNzE4MDQxMTQyLC0yOT
