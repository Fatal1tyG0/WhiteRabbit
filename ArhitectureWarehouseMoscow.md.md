...
Важно!!! Добавлять можно много товаров в возврат, с подписанием: Название товара, баркод, количество. Дата, адрес и qr-код к каждому возврату всегда один.</p>
</blockquote>

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTUwMjE0OTNdfQ==
-->