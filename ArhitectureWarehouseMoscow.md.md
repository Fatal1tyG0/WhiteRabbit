...
Данный компонент заполняется через форму для пользователя, которая выглядит следующим образом: 1) Название товара, 2) Размер товара или цвет (если необходим), 3) Количество товара, 4) Дата забора (прихода) возвратов, 5) Адрес забора возвратов (если осуществляется силами скл
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcyNzYxNjAyNSwtMTAwMzA1Mjg1LC03MT
