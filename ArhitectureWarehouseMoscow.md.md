...
> После заполнения вышеуказанных сведений "Остатки товара" из компонента `InventoryStock` приобретают свойства компонента `MyGoods`
---

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDE2NTI0MDgsLTM1NjQzNDkxNCwxMz
Y1MTA5MjMyXX0=
-->