...
<li>«Отправка товаров на склад» на стороне <strong>Администратора</strong><br>
...
<strong>Описание</strong></p>
<blockquote>
<p>Данный компонент представляет из себя рабочую область администратора. Которая выполнена в виде таблицы.</p>
</blockquote>
...
<strong>При нажатии на заказ администратор видит:</strong></li>
</ul>
<ol>
