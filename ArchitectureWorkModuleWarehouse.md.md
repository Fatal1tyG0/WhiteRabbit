...
Раздел предназначен для придания свойств товару пользователю, после чего он становится артикулом. Артикул приобретает свои свойства после указания их пользователем. В разделе перечислены все артикулы пользователя.</p>
...
<p><strong>Реализация раздела</strong> MyArticles<br>
Данный раздел представлен в виде таблицы, где перечислены компоненты «ArticleProducte” и пользователь видит в рабочей области все</p>
